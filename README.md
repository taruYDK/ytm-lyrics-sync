...
![Version 2.5.9](https://img.shields.io/badge/version-2.5.9-14b8a6?style=flat-square)
...
**v2.5.9**：歌詞クリックでシークしたときに、追跡の待機状態が残る問題を修正しました。
...
`src/` を編集したら `content.js` を再生成してください。v2.5.9では自動テスト61件と生成物一致を確認しています。実サイトでの表示・外部APIの動作は、このテストの保証範囲に含まれません。
