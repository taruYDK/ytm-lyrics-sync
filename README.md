...
![Version 2.5.10](https://img.shields.io/badge/version-2.5.10-14b8a6?style=flat-square)
...
**v2.5.10**：「その他」のふりがな編集を「歌詞を追加」の直下へ移動しました。
...
`src/` を編集したら `content.js` を再生成してください。v2.5.10では自動テスト61件と生成物一致を確認しています。実サイトでの表示・外部APIの動作は、このテストの保証範囲に含まれません。
