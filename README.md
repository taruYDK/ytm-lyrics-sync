...
![Version 2.5.6](https://img.shields.io/badge/version-2.5.6-14b8a6?style=flat-square)
...
**v2.5.6**：手動ふりがなの分割・言語別表示を修正し、保存データ管理とバックアップに統合しました。
...
`src/` を編集したら `content.js` を再生成してください。v2.5.6では自動テスト58件と生成物一致を確認しています。実サイトでの表示・外部APIの動作は、このテストの保証範囲に含まれません。
