...
test('popup: tracking settings restore, save numeric values and report failures',()=>{
 ...
 const c=vm.createContext({document,chrome,window:{addEventListener(){}},setTimeout:()=>1,clearTimeout(){}});vm.runInContext(readFileSync(new URL('../extension/popup.js',import.meta.url),'utf8'),c);
...
test('popup: rapid changes are coalesced and closing flushes the latest values',()=>{
 ...
 vm.runInContext(readFileSync(new URL('../extension/popup.js',import.meta.url),'utf8'),c);
