...
for(const line of gunzipSync(fs.readFileSync(new URL('../vendor/readings/cmudict.dict.gz',import.meta.url))).toString('utf8').split(/\r?\n/)){
...
fs.writeFileSync(new URL('../vendor/readings/english.json',import.meta.url),JSON.stringify(dict));
